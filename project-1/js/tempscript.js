...
$('.user-choice').on('click', function(e) {
  ...
  $.ajax({
    ...
    success : function(data) {
      $('.personal-page').append('<div class="col-sm-12>Latest price for </div>')
  }})
  ...
  $.ajax({
    ...
    success : function(data) {
      $('.content').html(data.query.results.channel[0].item.description)
  }})
  ...
  //     stocks: ['YHOO', 'GOOG'],
  //     city: 'kenosha',
  //     notes: ['Buy milk when you go to the store today!', 'Uh, half gallon.']
  //   },
  // ]
